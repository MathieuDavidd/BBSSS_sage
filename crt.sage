...
while j <=n:
	...
	alpha_before_exp.append(reed_solomon_alpha(j, m, k, n))
	
	tempso1 = reed_solomon_array(j, m, k, n, alpha_before_exp[i], [])
	#print("tempso1 : ", matrix(tempso1))
	
	matrix_before_exp.append(tempso1)
	
	
	tempso = reed_solomon_ext_matrix(j,m,k,n, tempso1)
